define([
    ...
    return React.createClass({
        ...
        render: function () {
            ...
            if (this.getBinding('notifications_options').get('full_view_notice_id') === notification.get('id')) {
                return (
                ...
                return (
                    _.div({onClick: this.setFullViewItem.bind(null, notification.get('id')), className: 'event-item', id: notification.get('id'), key: 'notice-' + index },
                        _.span({className: 'content-container'},
